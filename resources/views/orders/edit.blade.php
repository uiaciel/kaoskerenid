            ...
            <ul class="nav justify-content-center  ">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item text-dark" href="/admin/order/{{ $databelumbayar->inv }}">{{
                                $databelumbayar->klien->nama }} -
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item text-dark" href="/admin/order/{{ $lunasss->inv }}">{{
                                $lunasss->klien->nama }} -
                                #{{ $lunasss->inv }}</a></li>
                        @endforeach
                        @endforeach
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="detail" class="form-control" rows="15" style="
                        font-size: 1em;
                        font-weight: bold;
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number"
                                        class="form-control @if ($order->qty == null) is-invalid @endif" name="qty"
                                        value="{{ $order->qty }}">
    ...
    <div class="col-md-5 col-sm-12">
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center ">
                ...
                <a href="#" class="btn btn-primary btn-round" style="align-items: center" data-bs-toggle="modal"
                    data-bs-target="#PembayaranModal" role="button"><i class="bi bi-wallet"></i></a>
            ...
            <div class="card-body">
                ...
                <div class="alert alert-success">
                    <h4>Kurang Bayar : Rp {{ number_format($sisa, 0, ',', '.') }}</h4>
                </div>
        ...
        {{-- <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <ul>
                    <li><a href="{{ $file->path }}" download>{{ Str::remove('storage/' . $order->klien->hp . '/',
                            $file->path) }}</a></li>
                </ul>
                @endforeach
                <div class="collapse" id="contentId">
                    <form action="{{ route('design.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck1"><a href="{{ $paths->path }}" download>{{
                                    Str::remove('storage/' . $order->klien->hp . '/', $paths->path) }}</a></label>
                        </div>
                        <input type="text" name="kategori" value="EPS" hidden>
                        <input type="text" name="order_id" value="{{ $order->id }}" hidden>
                        <input type="text" name="klien_id" value="{{ $order->klien->id }}" hidden>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <a href="/admin/tambah/{{ $order->inv }}" class="btn btn-primary"><i class="fas fa-tshirt"></i>
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-bordered table-hover nowrap align-middle mb-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $loop->iteration }}
                                    <form action="{{ route('orderankatalog.destroy', $katalogini->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm"><i
                                                class="bi bi-trash3-fill"></i></button>
                            ...
                            <tr>
                                <th scope="row">
                                    <form action="{{ route('orderan.destroy', $orderannya->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm"><i
                                                class="bi bi-trash3-fill"></i></button>
                                ...
                                <td>
                                    <form action="{{ route('orderan.update', $orderannya->id) }}" method="Post">
                                        <input type="hidden" name="_method" value="PUT">
                                        @csrf
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('keuangan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="nominal" id="nominal" aria-describedby="helpId"
                            placeholder="">
...
<!-- Modal -->
<div class="modal fade" id="gallery" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
                        ...
                        <div class="col-12 col-sm-2">
                            <label class="imagecheck mb-4">
                                ...
                                <figure class="imagecheck-figure">
                                    <img src="{{ $alld->path }}" alt="title" class="imagecheck-image" loading="lazy">
                                </figure>
                                <input type="text" name="kategori" value="MOCKUP" hidden>
                                <input type="text" name="order_id" value="{{ $order->id }}" hidden>
                                <input type="text" name="klien_id" value="{{ $order->klien->id }}" hidden>
