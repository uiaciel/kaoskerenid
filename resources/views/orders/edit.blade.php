        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ml-auto">
                ...
                <a href="#" class="btn btn-primary btn-round" style="align-items: center" data-bs-toggle="modal"
                    data-bs-target="#PembayaranModal" role="button"><i class="fas fa-dollar-sign"></i> Bayar</a>

                <a href="/nota/{{ $order->inv }}" target="_blank" class="btn btn-success btn-round"><i class="fas fa-print"></i> NOTA</a>
                <button onclick="myFunction()" class="btn btn-success btn-danger"><i class="fas fa-copy"></i> Invoice</button>
            </div>
        </div>
    </div>
@endsection
            ...
            <form action="{{ route('order.update', $order->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex bd-highlight justify-content-between align-items-lg-center">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" data-date-format="yyyy-mm-dd"
                                        id="my_hidden_order" name="pengambilan" value="{{ $order->pengambilan }}" hidden>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="/tambah/{{ $order->inv }}" class="btn btn-primary"><i class="fas fa-tshirt"></i> Tambah produk</a>
