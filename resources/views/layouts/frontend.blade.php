...
<head>
    ...
    <meta name="keywords"
        content="@yield('meta_keys', 'Sablon Satuan, Sablon Bogor, Sablon Kota Bogor, Kaos kota bogor, kaos polos, bikin kaos satuan, kaos custom bogor, kaos terbaik bogor')">
    ...
    <meta name='og:description'
        content="@yield('meta_desc', 'Toko Sablon Satuan beralamat di Jalan Sancang No 22, Bogor Tengah, Kota Bogor melayani Sablon Satuan untuk Kaos, Hoodie, Topi, Sweater dan kebutuhan Cetak Digital.')">
    <!-- Favicon -->
                ...
                <div class="row">
                    <div class="col-lg-4 col-12 d-flex flex-wrap">
                        <p class="d-flex me-4 mb-0">
                            ...
                            <a href="https://maps.app.goo.gl/7vta7AaNHXaYdkZJ8"><strong class="text-dark">SABLON SATUAN
                                    KAOSKEREN.ID</strong></a>
                        </p>
                    </div>
