...
@section('title')
    <div class="container text-white py-2">
        <div class="d-flex flex-column flex-lg-row align-items-center">
            ...
            <div class="ml-auto">
                                <a href="/datastok/{{$stok->id}}/edit" class="btn btn-primary btn-round" style="align-items: center" role="button"><i class="fas fa-dollar-sign"></i> Input</a>

                <a href="/stok" class="btn btn-primary btn-round" style="align-items: center" role="button"><i class="fas fa-dollar-sign"></i> Stok</a>
