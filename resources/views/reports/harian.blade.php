...
<div class="row">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div>
            <form class="row">
                <div class="col-md-8"><input type="date" class="form-control" name="tanggal" id="" aria-describedby="helpId" placeholder="" /></div>

                <div class="col-md-4"> <button type="submit" name="" id="" class="btn btn-primary">
                    Submit
                </button></div>
                    ...
                    <div class="col-12 col-xl-8 px-xl-0">
                        <div class="ms-3">
                            ...
                            <h3 class="fw-extrabold mb-1">
                                Rp.{{ number_format($pemasukanharian->where('metode', 'Tunai')->pluck('nominal')->sum()
                                -$pengeluaranharian->where('metode', 'Tunai')->pluck('nominal')->sum(),0,',','.')
                                }}</b></b>
                            </h3>
                        </div><small class="ms-3 d-flex align-items-center">
                    ...
                    <div class="col-12 col-xl-12 px-xl-0">
                        <div class="ms-3">
                            ...
                            <span class="text-success me-2">TF : Rp
                                {{ number_format($pemasukanharian->where('metode',
                                'Transfer')->pluck('nominal')->sum(),0,',','.') }}
                            </span>
                            <span class="text-success me-2">Cash : Rp
                                {{ number_format($pemasukanharian->where('metode',
                                'Tunai')->pluck('nominal')->sum(),0,',','.') }}
                            </span>
                        </small>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-xl-12 px-xl-0 ms-3">
                        <div class="">
                            ...
                            <span class="text-danger me-2">TF :
                                Rp
                                {{ number_format($pengeluaranharian->where('metode',
                                'Transfer')->pluck('nominal')->sum(),0,',','.') }}
                            </span>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-bolder text-gray-500">
                                <a href="/admin/order/{{ $keuanganbulanan->detail }}">{{ $keuanganbulanan->detail }}</a>
                                - {{ $keuanganbulanan->kategori }} <span class="badge bg-primary">{{
                                    $keuanganbulanan->metode }} </span>
                            </td>
                ...
                <div class="row py-3">
                    <div class="col-md-12 d-flex flex-column text-end  justify-content-around">
                        ...
                        <div>
                            ...
                            <h3 class="fw-bold">Rp
                                {{ number_format($pemasukans->pluck('nominal')->sum() -
                                $pengeluarans->pluck('nominal')->sum(), 0, ',', '.') }}
                            </h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-md-8">
        <div class="card mb-3">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h2 class="fs-5 fw-bold mb-0">Qty <span class="badge bg-primary bg-pill">{{
                                $orders->pluck('qty')->sum() }} pcs</span></h2>
                    </div>
                    <div class="col text-end"> <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                    ...
                    <div class="d-flex align-items-center me-5">
                        ...
                        <div class="d-block"><label class="mb-0">Orderan</label>
                            ...
                            <div class="small d-flex mt-1"><svg class="icon icon-xs text-success" fill="currentColor"
                                ...
                                <div><span class="text-danger fw-bolder me-1">{{ $orderbulanlalu->count() }}</span>
                                    dari bulan lalu</div>
                            </div>
                    ...
                    <div class="d-flex align-items-center pt-3">
                        ...
                        <div class="d-block"><label class="mb-0">Klien baru</label>
                            ...
                            <div class="small d-flex mt-1"><svg class="icon icon-xs text-success" fill="currentColor"
                                ...
                                <div><span class="text-danger fw-bolder me-1">{{ $klienbulanlalu->count() }}</span>
                                    dari bulan lalu</div>
                            </div>
...
<!-- Modal -->
<div class="modal fade" id="catatPengeluaran" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
